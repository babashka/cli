...
Since `v0.3.31` babashka CLI auto-coerces values that have no explicit coercion
with
...
``` clojure
:exec {:deps {org.babashka/cli {:mvn/version "0.3.31"}}
...
``` clojure
:prn {:deps {org.babashka/cli {:mvn/version "0.3.31"}}
...
``` clojure
:antq {:deps {org.babashka/cli {:mvn/version "0.3.31"}
...
``` clojure
:codox {:extra-deps {org.babashka/cli {:mvn/version "0.3.31"}
...
``` clojure
:kaocha {:extra-deps {org.babashka/cli {:mvn/version "0.3.31"}
...
``` clojure
:build {:deps {org.babashka/cli {:mvn/version "0.3.31"}
...
``` clojure
:graph {:deps {org.babashka/cli {:mvn/version "0.3.31"}
