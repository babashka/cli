...
``` clojure
org.babashka/cli {:mvn/version "0.2.20"}
```
...
``` clojure
:exec {:deps {org.babashka/cli {:mvn/version "0.2.20"}}
...
``` clojure
:prn {:deps {org.babashka/cli {:mvn/version "0.2.20"}}
...
``` clojure
:antq {:deps {org.babashka/cli {:mvn/version "0.2.20"}
...
``` clojure
:codox {:extra-deps {org.babashka/cli {:mvn/version "0.2.20"}
...
``` clojure
:kaocha {:extra-deps {org.babashka/cli {:mvn/version "0.2.20"}
...
``` clojure
:build {:deps {org.babashka/cli {:mvn/version "0.2.20"}
...
``` clojure
:graph {:deps {org.babashka/cli {:mvn/version "0.2.20"}
...
{:clj-1.11 {:dependencies [[org.clojure/clojure "1.11.1"]]}
 :clj-new {:dependencies [[org.babashka/cli "0.2.20"]
