...
Since `v0.3.34` babashka CLI auto-coerces values that have no explicit coercion
with
...
``` clojure
:antq {:deps {org.babashka/cli {:mvn/version "0.3.34"}
...
``` clojure
:codox {:extra-deps {org.babashka/cli {:mvn/version "0.3.34"}
...
``` clojure
:kaocha {:extra-deps {org.babashka/cli {:mvn/version "0.3.34"}
...
``` clojure
:build {:deps {org.babashka/cli {:mvn/version "0.3.34"}
...
``` clojure
:graph {:deps {org.babashka/cli {:mvn/version "0.3.34"}
...
{:clj-1.11 {:dependencies [[org.clojure/clojure "1.11.1"]]}
 :clj-new {:dependencies [[org.babashka/cli "0.3.34"]
