...
``` clojure
:exec {:extra-deps {org.babashka/cli {:mvn/version "0.4.37"}}
...
``` clojure
:prn {:extra-deps {org.babashka/cli {:mvn/version "0.4.37"}}
...
``` clojure
:prn {:deps {org.babashka/cli {:mvn/version "0.4.37"}}
      :exec-fn clojure.core/prn
      :main-opts ["-m" "babashka.cli.exec"]
...
``` clojure
:antq {:deps {org.babashka/cli {:mvn/version "0.4.37"}
...
``` clojure
:codox {:extra-deps {org.babashka/cli {:mvn/version "0.4.37"}
...
``` clojure
:kaocha {:extra-deps {org.babashka/cli {:mvn/version "0.4.37"}
...
``` clojure
:build {:deps {org.babashka/cli {:mvn/version "0.4.37"}
...
``` clojure
:graph {:deps {org.babashka/cli {:mvn/version "0.4.37"}
...
{:clj-1.11 {:dependencies [[org.clojure/clojure "1.11.1"]]}
 :clj-new {:dependencies [[org.babashka/cli "0.4.37"]
