...
Since `v0.3.33` babashka CLI auto-coerces values that have no explicit coercion
with
...
``` clojure
:exec {:deps {org.babashka/cli {:mvn/version "0.3.33"}}
...
``` clojure
:prn {:deps {org.babashka/cli {:mvn/version "0.3.33"}}
...
``` clojure
:antq {:deps {org.babashka/cli {:mvn/version "0.3.33"}
...
``` clojure
:codox {:extra-deps {org.babashka/cli {:mvn/version "0.3.33"}
...
``` clojure
:kaocha {:extra-deps {org.babashka/cli {:mvn/version "0.3.33"}
...
``` clojure
:build {:deps {org.babashka/cli {:mvn/version "0.3.33"}
...
``` clojure
:graph {:deps {org.babashka/cli {:mvn/version "0.3.33"}
...
{:clj-1.11 {:dependencies [[org.clojure/clojure "1.11.1"]]}
 :clj-new {:dependencies [[org.babashka/cli "0.3.33"]
