...
- Add a `:help` option to `dispatch`: `(dispatch table args {:help {:prog "mytool"}})` (or `:help true`) gives a CLI built-in help - `--help`/`-h` print help for the command they precede, and a mistyped or missing subcommand prints help too
